###Script for using covariates to create values for plotting PCAs - adapted from Morris et al. 2019###
...
PlottingValues <- function(X,ColorGroup,ShapeGroup)
{
  ...
  out <- list(color = col.gp, legendcolor = legend.col, shape = shape.gp, legendshape = legend.shape)
